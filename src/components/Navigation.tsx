    ...
    <nav className="sticky top-0 z-50 bg-background border-b border-border shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          <Link href="/" className="text-xl sm:text-2xl font-serif font-bold text-primary tracking-tight flex-shrink-0">
          ...
          <div className="flex items-center gap-4 sm:gap-8">
            ...
            <Link href="/cart" className="relative group touch-target">
              <ShoppingCart size={20} className="sm:w-[22px] sm:h-[22px] text-foreground/70 group-hover:text-primary transition-colors duration-200" />
              {cartCount > 0 && (
