    ...
    <main className="bg-background py-8 sm:py-12 md:py-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-card rounded-lg p-6 sm:p-8 md:p-12 text-center border border-border">
          <CheckCircle
            size={56}
            className="sm:w-18 sm:h-18 mx-auto text-green-600 mb-4 sm:mb-6"
          />

          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-primary mb-1 sm:mb-2">
            Order Confirmed!
          </h1>
          <p className="text-foreground/70 text-sm sm:text-base md:text-lg mb-6 sm:mb-8">
            Thank you for shopping with Xtacia World. Your order is being
            prepared for shipment.
          </p>

          {order && (
            <div className="bg-accent rounded-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 text-left border border-border">
              <h2 className="font-serif text-lg sm:text-2xl font-bold text-primary mb-4 sm:mb-6">
                Order Summary
              </h2>
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-border">
                {order.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex justify-between text-sm sm:text-base gap-2"
                  >
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-6 sm:mb-8">
            ...
            <p className="text-blue-700 text-xs sm:text-sm mt-1">
              Payment will be completed after order confirmation. Paystack
